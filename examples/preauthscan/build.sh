#!/bin/bash
# Build script for Preauthscan BOF using MinGW cross-compiler
...
echo "Compiling x64..."
${CC_x64} -c preauthscan.c -o preauthscan.x64.o -Wall -I../../
if [ $? -ne 0 ]; then
...
echo "Compiling x86..."
${CC_x86} -c preauthscan.c -o preauthscan.x86.o -Wall -I../../
if [ $? -ne 0 ]; then

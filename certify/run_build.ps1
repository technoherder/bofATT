# Build script for Certify BOFs
# Explicitly use correct architecture compilers

Set-Location "c:\Users\techn\Documents\bof_template\certify"
if (-not (Test-Path bin)) { New-Item -ItemType Directory -Path bin | Out-Null }

$bofs = @('cert_cas', 'cert_find', 'cert_request', 'cert_download', 'cert_forge', 'cert_manageca', 'cert_pkiobjects', 'cert_request_agent')

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Building Certify BOF Suite" -ForegroundColor Cyan
...
foreach ($bof in $bofs) {
    $null = & "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\bin\Hostx64\x64\cl.exe" /c /GS- /Gs999999999 /Od /Ob1 /Oi- /I. /I../ /D WIN64 "$bof.c" /Fobin/"$bof.x64.o" 2>&1
...
foreach ($bof in $bofs) {
    $null = & "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.43.34808\bin\Hostx64\x86\cl.exe" /c /GS- /Gs999999999 /Od /Ob1 /Oi- /I. /I../ /D WIN32 "$bof.c" /Fobin/"$bof.x86.o" 2>&1
    if ($LASTEXITCODE -eq 0) {
